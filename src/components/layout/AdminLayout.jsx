...
export const AdminLayout = ({ currentRoute, onRouteChange, onRefresh, children }) => {
  return (
    <div className="flex h-screen w-screen bg-[#f0f2fb] text-[#181829] overflow-hidden font-sans">
      {/* Floating Purple Admin Sidebar */}
      <AdminSidebar currentRoute={currentRoute} onRouteChange={onRouteChange} />
